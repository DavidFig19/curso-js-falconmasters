...
*/
document.querySelector('#contenedor1').addEventListener('click',
	() => {
...
document.querySelector('#contenedor1 .caja').addEventListener('click', () => {
...
/*
	...
	En capturing el elemento padre reacciona primero y despues el elemento hijo.
*/
document.querySelector('#contenedor2').addEventListener('click',() => {
	console.log('Click en el contenedor');
}, true);

document.querySelector('#contenedor2 .caja').addEventListener('click', () => {
	console.log('Click en la caja');
});